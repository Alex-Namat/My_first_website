            ...
            <div class="row">
                <div class="col-12">
                    <form method="POST" action="/registration.php">
                        <div class="row from_reg"><input class="form" type="email" name="email" placeholder="Email"></div>
                        <div class="row from_reg"><input class="form" type="text" name="username" placeholder="Login"></div>
                        <div class="row from_reg"><input class="form" type="password" name="password" placeholder="Password"></div>
